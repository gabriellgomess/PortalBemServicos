...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      <div className="container-elipse">
        <div className="elipse-desktop-1"></div>
        <div className="elipse-desktop-2"></div>
        <div className="elipse-desktop-3"></div>
      </div>
      <div className="container-main">
        ...
        <Box>
          <Typography
            sx={{ textAlign: "center", color: "#EB8722" }}
            variant="h5"
          >
            Fale Conosco
          </Typography>
